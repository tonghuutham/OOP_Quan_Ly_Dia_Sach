...
public class UpdateNCC extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        NCC ncc = nccDAO.getByID(i);
        ncc.setTen(jTextField6.getText());
        ncc.setSDT(jTextField8.getText());
        ncc.setEmail(jTextField2.getText());
        ncc.setDiaDiem(jTextField3.getText());
        nccDAO.update(ncc);
        setVisible(false);
        new NCCUI().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        NCC ncc = nccDAO.getByID(i);
        if (ncc == null){
            JOptionPane.showMessageDialog(null, "Không tìm thấy thông tin Nhà cung cấp!");
            return;
        }
        jTextField6.setText(ncc.getTen());
        jTextField8.setText(ncc.getSDT());
        jTextField2.setText(ncc.getEmail());
        jTextField3.setText(ncc.getDiaDiem());
