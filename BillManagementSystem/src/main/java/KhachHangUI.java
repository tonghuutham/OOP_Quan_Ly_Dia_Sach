...
public class KhachHangUI extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        List<KhachHang> kh_list = khDAO.showAll();

        String[] columnName = {"ID", "Họ tên", "Số điện thoại", "Điểm", "Xếp hạng"};
        DefaultTableModel dtm = new DefaultTableModel(null, columnName);
        String[] data = new String[5];
        for (KhachHang kh : kh_list) {
            if (kh.getID() == 0)continue;
            data[0] = String.valueOf(kh.getID());
            data[1] = kh.getTen();
            data[2] = kh.getSDT();
            data[3] = String.valueOf(kh.getDiem());
            data[4] = String.valueOf(kh.getXepHang());
            dtm.addRow(data);
